...
#wait
# bsub -q $queue -W $time  -K -R "rusage[mem=$memory]" -R "select[model=XeonL5640]" 'Rscript ~/glm_eqtl/MatrixeQTLGLM/load_eqtls.R eqtlfolds testdb.db 10 100 testSNP.txt T' &
# wait
